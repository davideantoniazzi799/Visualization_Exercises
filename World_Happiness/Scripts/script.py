...
# DATA FOR 2015
df_2015 = pd.read_csv(DATA_DIR / 'wh_2015.csv', sep=',')
#df_2015.info()
...
# DATA FOR 2016
df_2016 = pd.read_csv(DATA_DIR / 'wh_2016.csv', sep=',')
#df_2016.info()
...
# DATA FOR 2017
df_2017 = pd.read_csv(DATA_DIR / 'wh_2017.csv', sep=',')
#df_2017.info()
...
# DATA FOR 2018
df_2018 = pd.read_csv(DATA_DIR / 'wh_2018.csv', sep=',')
#df_2018.info()
...
# DATA FOR 2019
df_2019 = pd.read_csv(DATA_DIR / 'wh_2019.csv', sep=',')
#df_2019.info()
...
df_final.to_csv(DATA_DIR / 'wh_complete.csv', index=False)